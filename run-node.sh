...
echo -e "${GREEN}Starting SkillSync Node.js Server${NC}"

# Check for existing processes on port 5002
echo -e "${YELLOW}Checking for existing processes on port 5002...${NC}"
...
echo -e "${GREEN}Running Node.js server on port $PORT${NC}"
echo -e "${GREEN}API will be available at http://localhost:5002${NC}"
npm run server:dev 